          ...
          articles: [
            {
              ...
              href: 'articles/foundation/c-basic/c-basic-syntax/c-basic-syntax.html',
              tags: ['C语言', '基础语法']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/foundation/pointer-memory/c-pointer-memory/c-pointer-memory.html',
              tags: ['指针', '内存模型']
            },
            {
              title: 'C语言 · 数据存储与指针',
              desc: '大小端 / 有符号与无符号 / 数据对齐 / size_t / typedef / enum / 数组与指针 / 二维指针 / void',
              href: 'articles/foundation/pointer-memory/c-data-storage-pointer/c-data-storage-pointer.html',
              tags: ['数据存储', '数据对齐']
            },
            {
              title: 'C语言 · 内存堆栈管理',
              desc: '进程 / 栈 / 堆 / mmap / 内存泄漏 / core dump / mprotect / Valgrind · 面向嵌入式 Linux 和 C 工程排错',
              href: 'articles/foundation/pointer-memory/c-stack-heap-memory/c-stack-heap-memory.html',
              tags: ['栈', '堆', 'Valgrind']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/foundation/data-structure/c-struct-data-layout/c-struct-data-layout.html',
              tags: ['struct', '协议帧']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/foundation/embedded-c/c-embedded-c/c-embedded-c.html',
              tags: ['嵌入式 C', 'GNU C']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/foundation/debug-engineering/c-debug-engineering/c-debug-engineering.html',
              tags: ['调试', 'HardFault']
            }
          ]
        }
          ...
          articles: [
            {
              ...
              href: 'articles/mcu/wh/cw32l011-ntc-adc-pwm/cw32l011-ntc-adc-pwm.html',
          ...
          articles: [
            {
              ...
              href: 'articles/mcu/microchip/pic16f18854-datasheet-notes/pic16f18854-datasheet-notes.html',
              tags: ['PIC16F18854', '数据手册']
            },
            {
              title: 'PIC16(L)F188XX · ICSP 存储器编程',
              desc: 'Microchip PIC16 · ICSP / SPI / NVM / EEPROM · 已整理存储器编程规范',
              href: 'articles/mcu/microchip/pic16f188xx-memory-programming/pic16f188xx-memory-programming.html',
              tags: ['PIC16', 'ICSP', 'NVM']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/mcu/silicon-labs/efm8bb10f8i-qfn20-development-notes/efm8bb10f8i-qfn20-development-notes.html',
              tags: ['EFM8', '8051', 'C2 Debug']
            },
            {
              title: 'ESP32 · C2 接口模拟烧写 EFM8 Flash',
              desc: 'ESP32-S3 GPIO Bit-Bang · C2CK / C2D 时序 · 擦除 / 写入 / 读回校验',
              href: 'articles/mcu/silicon-labs/esp32-c2-efm8-flash-programming/esp32-c2-efm8-flash-programming.html',
          ...
          articles: [
            {
              ...
              href: 'articles/fpga/hdl-basic/verilog-basic-syntax/verilog-basic-syntax.html',
              tags: ['Verilog', '基础语法']
            },
            {
              title: 'Verilog · 组合逻辑与时序逻辑',
              desc: '组合逻辑 / latch / 寄存器 / 复位 / 计数器 / 边沿检测 / 流水线 · 区分电路行为和代码写法',
              href: 'articles/fpga/hdl-basic/verilog-combinational-sequential/verilog-combinational-sequential.html',
              tags: ['组合逻辑', '时序逻辑']
            },
            {
              title: 'Verilog · 状态机设计方法',
              desc: 'FSM / 状态编码 / 三段式状态机 / Moore / Mealy / default安全状态 · 适合协议和采样流程控制',
              href: 'articles/fpga/hdl-basic/verilog-fsm-design/verilog-fsm-design.html',
              tags: ['FSM', '状态机']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/fpga/verification/verilog-testbench-debug/verilog-testbench-debug.html',
              tags: ['Testbench', '仿真']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/fpga/anlogic/aht20-iic-verilog/aht20-iic-verilog.html',
              tags: ['AHT20', 'IIC', 'CRC8']
            },
            {
              ...
              href: 'articles/fpga/anlogic/ef2-single-port-ram/ef2-single-port-ram.html',
              tags: ['EF2L45', 'BRAM']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/soc-linux/linux-basic/linux-basic-filesystem/linux-basic-filesystem.html',
              tags: ['Linux', '文件系统']
            },
            {
              title: 'Linux · 进程、线程与内存管理',
              desc: 'process / thread / maps / fd / signal / strace / core dump / gdb · 面向用户态程序排错',
              href: 'articles/soc-linux/linux-basic/linux-process-memory-thread/linux-process-memory-thread.html',
              tags: ['process', 'strace']
            },
            {
              title: 'Linux · Shell 脚本与 systemd 服务',
              desc: 'Shell / 变量 / 重定向 / 日志 / crontab / systemd / journalctl · 适合部署和开机自启',
              href: 'articles/soc-linux/linux-basic/linux-shell-systemd/linux-shell-systemd.html',
              tags: ['Shell', 'systemd']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/soc-linux/boot-kernel-rootfs/uboot-structure-build/uboot-structure-build.html',
            ...
            },
            {
              ...
              href: 'articles/soc-linux/boot-kernel-rootfs/kernel-structure-build/kernel-structure-build.html',
              tags: ['Kernel', 'Kconfig']
            },
            {
              title: 'RootFS · 根文件系统组成与构建',
              desc: 'BusyBox / Buildroot / Ubuntu Base / init / devtmpfs / rootfs.ext4 / squashfs · 梳理用户态文件系统构建',
              href: 'articles/soc-linux/boot-kernel-rootfs/rootfs-structure-build/rootfs-structure-build.html',
          ...
          articles: [
            {
              ...
              href: 'articles/soc-linux/driver-debug/linux-embedded-debug/linux-embedded-debug.html',
              tags: ['设备树', '板级调试']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/soc-linux/rockchip/rk3568-usb-ethernet-gadget/rk3568-usb-ethernet-gadget.html',
              tags: ['RK3568', 'USB Gadget']
            },
            {
              title: 'RK3568 · SPI / spidev',
              desc: 'Linux 5.10 / SPI / spidev / Ubuntu Base 22 · 已整理 SPI 功能调试记录',
              href: 'articles/soc-linux/rockchip/rk3568-spi-spidev/rk3568-spi-spidev.html',
          ...
          articles: [
            {
              ...
              href: 'articles/realtime/freertos-basic/freertos-basic-scheduler/freertos-basic-scheduler.html',
              tags: ['FreeRTOS', '调度']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/realtime/task-management/freertos-task-management/freertos-task-management.html',
              tags: ['任务管理', '任务栈']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/realtime/ipc-sync/freertos-ipc-sync/freertos-ipc-sync.html',
              tags: ['队列', '互斥锁']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/realtime/timer-memory-debug/freertos-timer-memory-debug/freertos-timer-memory-debug.html',
              tags: ['软件定时器', '调试']
            }
          ]
        }
          ...
          articles: [
            {
              ...
              href: 'articles/host-tools/debug-config/windows-vscode-remote-linux-cpp-debug/windows-vscode-remote-linux-cpp-debug.html',
              tags: ['VS Code', '远程调试']
            }
          ]
        }
          ...
          articles: [
            {
              ...
              href: 'articles/dev-tools/windows-install/uqitong-usb-win-install/uqitong-usb-win-install.html',
              tags: ['优启通', 'U盘启动盘']
            }
          ]
        },
          ...
          articles: [
            {
              ...
              href: 'articles/dev-tools/pxe-iventoy/iventoy-pxe-win-install/iventoy-pxe-win-install.html',
              tags: ['iVentoy', 'PXE装机']
            }
          ]
        },
