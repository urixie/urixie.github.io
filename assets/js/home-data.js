  ...
  const siteMap = [
    {
      ...
      "children": [
        ...
        },
        {
          "id": "data-structure",
          "title": "数据结构与数据组织",
          "desc": "整理结构体、协议数据组织、队列、环形缓冲区等可复用基础数据结构与工程实现。",
          "articles": [
            {
              "title": "C语言 · 结构体与数据组织",
            ...
            {
              "title": "环形缓冲区 · 原理、Linux 与 RT-Thread 实现",
              "desc": "Ring Buffer / head-tail / mirror bit / Linux circ_buf / kfifo / RT-Thread / SPSC / UART / DMA",
              "href": "articles/foundation/data-structure/ring-buffer/ring-buffer.html",
              "tags": [
                "Ring Buffer",
                "Linux",
                "RT-Thread",
